...
import pandas as pd
import os
from Setting_ERAInterim import MADSL_Type
import requests

class ERA_Interim_MAD_SL:
    """
       you can find EAR-Interim monthly average data via: https://gdex.ucar.edu/datasets/d627001/dataaccess/#
    """
    def __init__(self, path='I:/ERA_Interim/MAD_SL/'):
    ...
    def setVariable(self,variable:MADSL_Type):
        if variable == MADSL_Type.SurPressure:
            self.variable = 'ei.moda.an.sfc/ei.moda.an.sfc.regn128sc.'
            self.filename = 'sp'
        return self
...
if __name__ == "__main__":
    a = ERA_Interim_MAD_SL(path='I:/ERA_Interim/MAD_SL/')
