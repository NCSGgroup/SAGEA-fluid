...
from lib.SaGEA.post_processing.geometric_correction.old.Setting import FieldType, Assumption, Constants, HarAnalysisType, \
...
from lib.SaGEA.post_processing.geometric_correction.old.GeoidUndulation import GeoidUndulation
...
class GeometricalCorrection:
    ...
    def __prepare(self):
        ...
        LN = LoveNumber(FileTool.get_project_dir('data/ancillary/'))
