...
from pysrc.NUM.Setting.Setting import DataType
# import Ngl, Nio
import cfgrib
import xarray
...
class LoadFields:
    """
    This class deals with loading all necessary inputs for one cycle of NUM computation.
    """
    ...
    def setTime_for_tide(self, date='2020-01-01', time='06:00:00'):
        """
        set the time epoch of data that will be used in later computation.
        :param OnlyPressure: if True, then only pressure is read.
        :param date:
