...
from pysrc.NUM.VerProcess.GeopotentialHeight import GeopotentialHeight, LoadFields
from pysrc.NUM.VerProcess.RefEllipsoid import RefEllipsoid
from pysrc.NM.Setting.Setting import IntegralChoice, EllipsoidType, Constants
...
class InnerIntegral:
    ...
    def defaultConfig(isWrite=True):
        ...
        if isWrite:
            with open('../../../pysrc/Settings/integral.setting.json', 'w') as f:
