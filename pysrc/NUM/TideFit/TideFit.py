...
"""
import json
from pysrc.NUM.MathKit.GeoMathKit import GeoMathKit
from scipy import signal
from pysrc.NUM.LoadFile.LoadFields import LoadFields, DataType
from pysrc.NUM.MathKit.Harmonic import Harmonic, LoveNumber, LoveNumberType, HarAnalysisType,EllipsoidType
from pysrc.NUM.MathKit.Format import FormatWrite, CnmSnm
from pysrc.NUM.SufProcess.SurPres2CS import SurPres2CS, RefEllipsoid
from pysrc.NUM.VerProcess.GeoidUndulation import GeoidUndulation
import numpy as np
import os
import time as ti
...
class TideFit:
    ...
    def __init__(self):
        ...
        self._LoveNumberPath = "../../../../Data/Auxiliary/"
    ...
    def generateTide_bySphere(self,end:str, tides: dict, Nmax: int, lat, lon):
        ...
        LN = LoveNumber(self._LoveNumberPath)
...
def demo2():
    ...
    tf.setDataDir(dataDirIn='I:/ERA5/model level/', dataDirOut='I:\PyCode\DeAliasing/')
    tf.setDuration(begin='2020-01-01', end='2020-12-31')
    tf.fit()
    ...
    tf.generateTide_bySphere(end='2020',tides=tides, Nmax=180, lat=lat, lon=lon)
    # tf.generateTide_byTopography(end='2020',tides=tides, Nmax=180, lat=lat, lon=lon)

def demo3():
    with open('../../../pysrc/Settings/TideFit.json', 'r') as f:
        config = json.load(f)
    tf = TideFit().setButterworth()
