...
from lib.SaGEA.auxiliary.preference.EnumClasses import match_string
...
from lib.SaGEA.post_processing.convert_field_physical_quantity.ConvertSHC import ConvertSHC
from lib.SaGEA.post_processing.filter.GetSHCFilter import get_filter
from lib.SaGEA.post_processing.geometric_correction.GeometricalCorrection import GeometricalCorrection
from lib.SaGEA.post_processing.harmonic.Harmonic import Harmonic, HarmonicOld, GRDType
from lib.SaGEA.post_processing.replace_low_deg.ReplaceLowDegree import ReplaceLowDegree
...
class SHC:
    ...
    def __init__(self, c, s=None, dates=None, normalization=None, physical_dimension=None):
        ...
        self.LLN_Frame = Frame.CF
        self.LLN_method = LLN_Data.Wang
        # self.LLN_variable = LLN_variable.k

    def setLoveNumber(self,method,frame):
        self.LLN_Frame = frame
    ...
    def convert_type(self, from_type=None, to_type=None):
        ...
        LN = LoveNumber().config(lmax=lmax,method=self.LLN_method).get_Love_number()
        LN.convert(target=self.LLN_Frame)
        ln = LN.LLN[LLN_variable.k]
