...
import warnings
import numpy as np
from pysrc.KITs.Setting.EnumClasses import AODtype,TidesType
...
class AOD_GFZ(LoadSH):
    """
    This class is used to read stokes coefficients at given epoch from NUM product.
    """
    ...
    def load(self, fileIn: str):
        """
        set the directory of NUM products to be read
        :param fileIn:
        :return:
        """
    ...
    def setTime(self, date: str, epoch: str):
        """
        specify the epoch of NUM file to be read
...
def demo1():
    # a = Gif48().load('../data/ancillary/GIF48.gfc')
    a = Gif48().load('../data/ancillary/ITG-Grace2010s.gfc')
    C0, S0 = a.getCS(100)
...
def demo2():
    a = SimpleSH().load('../data/ancillary/ocean360_grndline.sh')
    C0, S0 = a.getCS(360)
    pass
